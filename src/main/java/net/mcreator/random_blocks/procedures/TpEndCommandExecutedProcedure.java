...
public class TpEndCommandExecutedProcedure extends RandomBlocksModElements.ModElement {
	public TpEndCommandExecutedProcedure(RandomBlocksModElements instance) {
		super(instance, 186);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure TpEndCommandExecuted!");
			return;
		}
