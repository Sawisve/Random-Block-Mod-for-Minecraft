...
public class LamplitOnBlockRightClickedProcedure extends RandomBlocksModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure LamplitOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure LamplitOnBlockRightClicked!");
			return;
		}
