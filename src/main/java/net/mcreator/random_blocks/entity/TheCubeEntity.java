...
public class TheCubeEntity extends RandomBlocksModElements.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelCube(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("random_blocks:textures/cube.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, SlimeEntity.class, false, false));
		}
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Items.STICK, (int) (1)));
		}
	...
	public static class ModelCube extends EntityModel<Entity> {
