...
import net.mcreator.random_blocks.procedures.SurvivalOnKeyPressedProcedure;
...
public class SurvivalKeyBinding extends RandomBlocksModElements.ModElement {
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.survival", GLFW.GLFW_KEY_F7, "key.categories.misc");
