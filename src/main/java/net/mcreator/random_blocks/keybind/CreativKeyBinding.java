...
import net.mcreator.random_blocks.procedures.CreativOnKeyPressedProcedure;
...
public class CreativKeyBinding extends RandomBlocksModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.creativ", GLFW.GLFW_KEY_F8, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				CreativOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
