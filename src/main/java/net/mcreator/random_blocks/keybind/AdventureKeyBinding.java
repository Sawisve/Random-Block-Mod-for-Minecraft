...
import net.mcreator.random_blocks.procedures.AdventureOnKeyPressedProcedure;
...
public class AdventureKeyBinding extends RandomBlocksModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.adventure", GLFW.GLFW_KEY_F9, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				AdventureOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
