...
import net.mcreator.random_blocks.procedures.SpectatorOnKeyPressedProcedure;
...
public class SpectatorKeyBinding extends RandomBlocksModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.spectator", GLFW.GLFW_KEY_F10, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				SpectatorOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
