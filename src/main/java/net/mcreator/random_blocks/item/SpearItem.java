...
import net.mcreator.random_blocks.procedures.SpearBulletHitsBlockProcedure;
...
public class SpearItem extends RandomBlocksModElements.ModElement {
	@ObjectHolder("random_blocks:iron_spear")
		...
		public Multimap<String, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot) {
			...
			if (slot == EquipmentSlotType.MAINHAND) {
				multimap.put(SharedMonsterAttributes.ATTACK_DAMAGE.getName(),
						new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "ranged_item_damage", (double) 1.2, AttributeModifier.Operation.ADDITION));
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			World world = this.world;
			{
				...
				SpearHitProcedureProcedure.executeProcedure($_dependencies);
			}
		}
