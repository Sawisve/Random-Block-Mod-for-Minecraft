...
import net.mcreator.random_blocks.procedures.SSpearUsedProcedure;
import net.mcreator.random_blocks.procedures.SSpearHitProcedure;
import net.mcreator.random_blocks.procedures.SSpearHitBlockProcedure;
...
public class StoneSpearItem extends RandomBlocksModElements.ModElement {
	@ObjectHolder("random_blocks:stone_spear")
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 2.6999999999999997, 1);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			World world = this.world;
			{
				...
				SSpearHitProcedure.executeProcedure($_dependencies);
			}
		}
			...
			if (this.inGround) {
				{
					...
					$_dependencies.put("z", z);
					$_dependencies.put("world", world);
					SSpearHitBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
	...
	public static ArrowCustomEntity shoot(LivingEntity entity, LivingEntity target) {
		...
		entityarrow.setSilent(true);
		entityarrow.setDamage(2.6999999999999997);
