...
public class DeadWoodFenceBlock extends RandomBlocksModElements.ModElement {
	@ObjectHolder("random_blocks:dead_wood_fence")
	public static final Block block = null;
	public DeadWoodFenceBlock(RandomBlocksModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_wood_fence");
		}
