...
public class CobblestoneSignBlock extends RandomBlocksModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("cobblestone_sign");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			switch ((Direction) state.get(FACING)) {
				...
				case SOUTH :
				default :
					return VoxelShapes.create(1D, 0D, 0.6D, 0D, 1D, 0.33D);
				case NORTH :
					return VoxelShapes.create(0D, 0D, 0.4D, 1D, 1D, 0.67D);
				case WEST :
					return VoxelShapes.create(0.4D, 0D, 1D, 0.67D, 1D, 0D);
				case EAST :
					return VoxelShapes.create(0.6D, 0D, 0D, 0.33D, 1D, 1D);
			}
		}
