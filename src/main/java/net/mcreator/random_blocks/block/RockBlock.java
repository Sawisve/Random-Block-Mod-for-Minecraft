...
import net.mcreator.random_blocks.procedures.RockBlockAddedProcedure;
...
public class RockBlock extends RandomBlocksModElements.ModElement {
	@ObjectHolder("random_blocks:rock")
	public static final Block block = null;
	public RockBlock(RandomBlocksModElements instance) {
		super(instance, 100);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
			{
				...
				RockBlockAddedProcedure.executeProcedure($_dependencies);
			}
		}
