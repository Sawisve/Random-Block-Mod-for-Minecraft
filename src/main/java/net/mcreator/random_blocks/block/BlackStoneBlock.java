...
public class BlackStoneBlock extends RandomBlocksModElements.ModElement {
	@ObjectHolder("random_blocks:black_stone")
	public static final Block block = null;
	public BlackStoneBlock(RandomBlocksModElements instance) {
		super(instance, 11);
	}
