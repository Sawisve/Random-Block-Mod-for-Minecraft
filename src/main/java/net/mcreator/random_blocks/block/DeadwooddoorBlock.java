...
public class DeadwooddoorBlock extends RandomBlocksModElements.ModElement {
	@ObjectHolder("random_blocks:dead_wood_door")
	public static final Block block = null;
	public DeadwooddoorBlock(RandomBlocksModElements instance) {
		super(instance, 68);
	}
