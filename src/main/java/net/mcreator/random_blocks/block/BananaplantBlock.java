...
import net.mcreator.random_blocks.item.BananaItem;
...
public class BananaplantBlock extends RandomBlocksModElements.ModElement {
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BananaItem.block, (int) (2)));
		}
