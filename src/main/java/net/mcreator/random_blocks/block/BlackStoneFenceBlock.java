...
public class BlackStoneFenceBlock extends RandomBlocksModElements.ModElement {
	@ObjectHolder("random_blocks:black_stone_fence")
	public static final Block block = null;
	public BlackStoneFenceBlock(RandomBlocksModElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("black_stone_fence");
		}
